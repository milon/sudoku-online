...
?>
<div ng-app="cardTableApp" ng-controller="tableController" @include('crud::inc.field_wrapper_attributes') >
            ...
            <tbody ui-sortable="sortableOptions" ng-model="items" class="table-striped">
                ...
                <tr ng-repeat="item in items" class="array-row">
                    ...
                    @foreach( $field['columns'] as $prop => $label)
                        @if($prop == 'game')
                            <td>
                                <select class="form-control input-sm" ng-model="item.{{ $prop }}" required>
                                    @php
                                        $games = App\Models\Game::select('id', 'name')->get();
                                    @endphp
                        ...
                        @else
                            <td>
                                <input class="form-control input-sm" type="number" ng-model="item.{{ $prop }}" required>
                            </td>
                        @endif
                    @endforeach
...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    @push('crud_fields_scripts')
        ...
        <script>
            ...
            window.angularApp = window.angularApp || angular.module('cardTableApp', [], function($interpolateProvider){
